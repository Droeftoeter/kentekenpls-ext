import { subDays, queryFormat } from "./util/date";
...
const Where = {
  ...
  EuroL1e:
    "europese_voertuigcategorie = 'L1' AND europese_voertuigcategorie_toevoeging = 'e'",
  ...
  EuroL2e:
    "europese_voertuigcategorie = 'L2' AND europese_voertuigcategorie_toevoeging = 'e'",
  // 2 wielen, geen zijspan en meer vermogen dan L1e.
  EuroL3e:
    "europese_voertuigcategorie = 'L3' AND europese_voertuigcategorie_toevoeging = 'e'",
  // 2 wielen + zijspanen meer vermogen dan L1e
  EuroL4e:
    "europese_voertuigcategorie = 'L4' AND europese_voertuigcategorie_toevoeging = 'e'",
  // 3 symmetrische wielen en meer vermogen dan L2e
  EuroL5e:
    "europese_voertuigcategorie = 'L5' AND europese_voertuigcategorie_toevoeging = 'e'",
  // Quads die niet meer wegen dan 350 kg (excl. accupack) + eigenschappen L2e
  EuroL6e:
    "europese_voertuigcategorie = 'L6' AND europese_voertuigcategorie_toevoeging = 'e'",
  ...
  EuroL7e:
    "europese_voertuigcategorie = 'L7' AND europese_voertuigcategorie_toevoeging = 'e'",
          ...
          items: [
            ...
            },
            {
              ...
              where: [
                ...
                Where.GeenCamper,
                `merk = 'AUDI'`,
                `(${["TTS", "S3", "S4", "S5", "S6", "S7", "S8"]
                  .map((v) => `starts_with(\`handelsbenaming\`, '${v}')`)
                  .join(" OR ")})`,
              ],
            },
            {
      ...
      items: [
        {
          id: "motor",
          title: "Motor",
          where: [Where.NietExport, Where.Motorfiets, Where.TweeWielen],
        },
        {
          id: "motor-zijspan",
          title: "Motor met zijspan",
          where: [Where.NietExport, Where.EuroL4e],
        },
        {
          id: "motor-trike",
          title: "Trike",
          where: [Where.NietExport, Where.EuroL5e],
        },
        {
          id: "motor-quad",
          title: "Quad",
          where: [Where.NietExport, Where.EuroL7e],
        },
        {
          id: "motor-import",
          title: "Geimporteerd",
        ...
        },
        {
          id: "motor-oldtimer",
          title: "Oldtimer",
          where: [Where.NietExport, Where.Motorfiets, Where.WelOldtimer],
        },
      ],
    },
      ...
      items: [
        {
          id: "aanhangwagen",
          title: "Aanhangwagen",
          where: [Where.NietExport, Where.Aanhangwagen],
        },
        {
          id: "aanhangwagen-caravan",
          title: "Caravan",
          where: [Where.NietExport, Where.Aanhangwagen, Where.Caravan],
        },
        {
          id: "aanhangwagen-oplegger",
          title: "Oplegger",
          where: [Where.NietExport, Where.Oplegger],
        },
      ],
    },
  ],
