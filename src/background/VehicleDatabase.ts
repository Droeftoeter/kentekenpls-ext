...
export default class VehicleDatabase extends Dexie {
     ...
     * @param {string} digest
     */
    getByQueryKeyAndDigest(queryKey: string, digest: string): Promise<StoredRdwOpenDataVehicle[]> {
        return this
            .vehicles
     ...
     */
    saveVehicle(queryKey: string, digest: string, vehicle: RdwOpenDataVehicle): void {
        this
            .vehicles
            .add({
                queryKey,
     ...
     * @param {string }digest
     */
    removeByQueryKeyWhereDigestDoesNotMatch(queryKey: string, digest: string): void {
        this
            .vehicles
            .where({ queryKey })
